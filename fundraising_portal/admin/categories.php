...
if(isset($_GET['type']) && $_GET['type']!=''){
	...
	if($type=='status'){
		...
		//the UPDATE command to modify the data in the MySQL table 
		  ...
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   ...
				   <h4 class="box-link"><a href="categories.php">ADD CATEGORIES</a></h4> </h4>
				</div>
				<div class="card-body--">
				   <div class="table-stats order-table ov-h">
					  <table class="table ">
						 ...
						 <tbody>
							...
							$i=1;
							$res=mysqli_query($con,$sql);
							//to return an associative array representing the next row in the result set 
